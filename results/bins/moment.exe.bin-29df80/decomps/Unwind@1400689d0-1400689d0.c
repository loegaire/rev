...
void Unwind_1400689d0(undefined8 param_1,longlong param_2)
...
LAB_140068a8d:
        ...
        if (uVar11 == uVar4) goto LAB_140068a8d;
      }
LAB_140068a43:
...
LAB_140068bd1:
  ...
  *(undefined1 *)(param_2 + 0x11c7) = 1;
  return;
LAB_140068bbf:
  (*pcVar10)(*(undefined8 *)(param_2 + 0x310),0,0x8000);
  goto LAB_140068bd1;
}
