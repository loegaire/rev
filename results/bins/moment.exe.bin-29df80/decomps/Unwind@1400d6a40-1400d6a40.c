...
void Unwind_1400d6a40(undefined8 param_1,longlong param_2)

{
  ...
  pvVar1 = *(void **)(param_2 + 0x98);
  if (pvVar1 != (void *)0x0) {
    pvVar3 = pvVar1;
    if ((0xfff < (ulonglong)(*(longlong *)(param_2 + 0xa8) - (longlong)pvVar1)) &&
...
LAB_1400d6bad:
    ...
    free(pvVar3);
    *(undefined1 (*) [16])(param_2 + 0x98) = (undefined1  [16])0x0;
    *(undefined8 *)(param_2 + 0xa8) = 0;
  }
  plVar4 = *(longlong **)(param_2 + 0x88);
    ...
    do {
      ...
      if (pvVar1 != (void *)0x0) {
        ...
        if ((0xfff < (ulonglong)(plVar4[9] - (longlong)pvVar1)) &&
           (pvVar3 = *(void **)((longlong)pvVar1 + -8),
           0x1f < (ulonglong)((longlong)pvVar1 + (-8 - (longlong)pvVar3)))) goto LAB_1400d6bad;
        free(pvVar3);
