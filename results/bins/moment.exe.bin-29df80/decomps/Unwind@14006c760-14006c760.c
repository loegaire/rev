...
void Unwind_14006c760(undefined8 param_1,longlong param_2)
...
LAB_14006c81d:
        ...
        if (uVar11 == uVar4) goto LAB_14006c81d;
      }
LAB_14006c7d3:
...
LAB_14006c961:
  *(longlong *)(param_2 + 0x1b8) = param_2 + 0x700;
  *(undefined1 *)(param_2 + 0x1185) = 1;
  return;
LAB_14006c94f:
  (*pcVar10)(*(undefined8 *)(param_2 + 0x6c0),0,0x8000);
  goto LAB_14006c961;
}
