...
void Unwind_1400d8430(undefined8 param_1,longlong param_2)

{
  ...
  plVar1 = *(longlong **)(param_2 + 0x2388);
  pauVar2 = *(undefined1 (**) [16])(param_2 + 0x2390);
  pvVar3 = *(void **)*pauVar2;
  if (pvVar3 != (void *)0x0) {
    pvVar5 = pvVar3;
    if ((0xfff < (ulonglong)
                 (*(longlong *)(*(longlong *)(param_2 + 0x23a0) + 0x48) - (longlong)pvVar3)) &&
    ...
    do {
      ...
      if (pvVar3 != (void *)0x0) {
        ...
        if ((0xfff < (ulonglong)(plVar6[9] - (longlong)pvVar3)) &&
           (pvVar5 = *(void **)((longlong)pvVar3 + -8),
           0x1f < (ulonglong)((longlong)pvVar3 + (-8 - (longlong)pvVar5)))) goto LAB_1400d85b8;
        free(pvVar5);
