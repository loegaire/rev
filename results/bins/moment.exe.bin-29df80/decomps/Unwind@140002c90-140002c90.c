...
void Unwind_140002c90(undefined8 param_1,longlong param_2)
...
LAB_140002d3d:
      ...
      if ((ulonglong)uVar11 != 0) {
        ...
        if ((uVar4 <= uVar11) ||
           ((code *)(lVar6 + (ulonglong)*(uint *)(lVar3 + 0x8c + (longlong)*(int *)(lVar3 + 0x3c)))
            <= pcVar10)) {
          (*pcVar10)(*(undefined8 *)(param_2 + 0x110),0,0x8000);
          return;
        }
        uVar5 = 0x1cba1898;
        uVar4 = 0x1cba1898;
      ...
      if (uVar11 == uVar4) goto LAB_140002d3d;
    }
LAB_140002cf3:
