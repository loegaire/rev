...
longlong * FUN_1400f9840(longlong *param_1)

{
  ...
  pauVar3 = (undefined1 (*) [32])(*pcVar2)(0,0x39,0x3000,4);
  *param_1 = (longlong)pauVar3;
  *pauVar3 = ZEXT1232(ZEXT812(0));
  *(undefined1 (*) [32])(*pauVar3 + 0x19) = ZEXT1232(ZEXT812(0));
  if (*param_1 != 0) {
    ...
    *(byte *)*param_1 = bVar1 ^ 0x9a;
    plVar4 = (longlong *)(*(code *)0x62058d4818eb9b75)();
    return plVar4;
  }
  return param_1;
}
