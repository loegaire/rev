...
void Unwind_14006b2d0(undefined8 param_1,longlong param_2)
...
LAB_14006b38d:
        ...
        if (uVar11 == uVar4) goto LAB_14006b38d;
      }
LAB_14006b343:
...
LAB_14006b4d1:
  *(undefined8 *)(param_2 + 0x228) = 0xf;
  *(longlong *)(param_2 + 0x220) = param_2 + 0x840;
  *(undefined1 *)(param_2 + 0x118e) = 1;
  return;
LAB_14006b4bf:
  (*pcVar10)(*(undefined8 *)(param_2 + 0x470),0,0x8000);
  goto LAB_14006b4d1;
}
