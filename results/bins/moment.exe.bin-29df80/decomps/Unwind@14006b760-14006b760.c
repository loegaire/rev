...
void Unwind_14006b760(undefined8 param_1,longlong param_2)
...
LAB_14006b81d:
        ...
        if (uVar11 == uVar4) goto LAB_14006b81d;
      }
LAB_14006b7d3:
...
LAB_14006b961:
  *(undefined8 *)(param_2 + 0x210) = 0xf;
  *(longlong *)(param_2 + 0x208) = param_2 + 0x800;
  *(undefined1 *)(param_2 + 0x118c) = 1;
  return;
LAB_14006b94f:
  (*pcVar10)(*(undefined8 *)(param_2 + 0x450),0,0x8000);
  goto LAB_14006b961;
}
