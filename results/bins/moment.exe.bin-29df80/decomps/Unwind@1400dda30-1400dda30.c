...
void Unwind_1400dda30(undefined8 param_1,longlong param_2)

{
  ...
  pvVar1 = (void *)**(longlong **)(param_2 + 0x60);
  plVar2 = *(longlong **)(param_2 + 0x30);
  if (pvVar1 != (void *)0x0) {
    pvVar5 = pvVar1;
    if ((0xfff < (ulonglong)(*(longlong *)(*(longlong *)(param_2 + 0xa0) + 0x48) - (longlong)pvVar1)
...
LAB_1400ddba9:
    ...
    free(pvVar5);
    pauVar3 = *(undefined1 (**) [16])(param_2 + 0x60);
    ...
    do {
      ...
      if (pvVar1 != (void *)0x0) {
        ...
        if ((0xfff < (ulonglong)(plVar6[9] - (longlong)pvVar1)) &&
           (pvVar5 = *(void **)((longlong)pvVar1 + -8),
           0x1f < (ulonglong)((longlong)pvVar1 + (-8 - (longlong)pvVar5)))) goto LAB_1400ddba9;
        free(pvVar5);
