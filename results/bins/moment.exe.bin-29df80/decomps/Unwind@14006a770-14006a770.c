...
void Unwind_14006a770(undefined8 param_1,longlong param_2)
...
LAB_14006a82d:
        ...
        if (uVar11 == uVar4) goto LAB_14006a82d;
      }
LAB_14006a7e3:
...
LAB_14006a971:
  *(longlong *)(param_2 + 0x260) = param_2 + 0x8c0;
  *(undefined1 *)(param_2 + 0x1193) = 1;
  return;
LAB_14006a95f:
  (*pcVar10)(*(undefined8 *)(param_2 + 0x610),0,0x8000);
  goto LAB_14006a971;
}
