...
void Unwind_1400692e0(undefined8 param_1,longlong param_2)
...
LAB_14006939d:
        ...
        if (uVar11 == uVar4) goto LAB_14006939d;
      }
LAB_140069353:
...
LAB_1400694e1:
  *(undefined8 *)(param_2 + 0x2d0) = 0xf;
  *(longlong *)(param_2 + 0x2c8) = param_2 + 0xa00;
  *(undefined1 *)(param_2 + 0x119c) = 1;
  return;
LAB_1400694cf:
  (*pcVar10)(*(undefined8 *)(param_2 + 0x370),0,0x8000);
  goto LAB_1400694e1;
}
