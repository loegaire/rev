...
void Unwind_14006a090(undefined8 param_1,longlong param_2)
...
LAB_14006a14d:
        ...
        if (uVar11 == uVar4) goto LAB_14006a14d;
      }
LAB_14006a103:
...
LAB_14006a291:
  *(undefined8 *)(param_2 + 0x288) = 0xf;
  *(longlong *)(param_2 + 0x280) = param_2 + 0x940;
  *(undefined1 *)(param_2 + 0x1196) = 1;
  return;
LAB_14006a27f:
  (*pcVar10)(*(undefined8 *)(param_2 + 0x4f0),0,0x8000);
  goto LAB_14006a291;
}
