...
void Unwind_14006a2e0(undefined8 param_1,longlong param_2)
...
LAB_14006a39d:
        ...
        if (uVar11 == uVar4) goto LAB_14006a39d;
      }
LAB_14006a353:
...
LAB_14006a4e1:
  *(longlong *)(param_2 + 0x278) = param_2 + 0x900;
  *(undefined1 *)(param_2 + 0x1195) = 1;
  return;
LAB_14006a4cf:
  (*pcVar10)(*(undefined8 *)(param_2 + 0x630),0,0x8000);
  goto LAB_14006a4e1;
}
