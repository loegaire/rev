...
void Unwind_14006b520(undefined8 param_1,longlong param_2)
...
LAB_14006b5dd:
        ...
        if (uVar11 == uVar4) goto LAB_14006b5dd;
      }
LAB_14006b593:
...
LAB_14006b721:
  *(longlong *)(param_2 + 0x218) = param_2 + 0x800;
  *(undefined1 *)(param_2 + 0x118d) = 1;
  return;
LAB_14006b70f:
  (*pcVar10)(*(undefined8 *)(param_2 + 0x5b0),0,0x8000);
  goto LAB_14006b721;
}
