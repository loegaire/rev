...

{
  ...
  DAT_14012b300 = std::locale::_Init(true);
  ...
  if ((((*(ulonglong *)(DAT_14012b300 + 0x18) <= uVar17) ||
       (p_Var16 = *(_Facet_base **)(*(longlong *)(DAT_14012b300 + 0x10) + uVar17 * 8),
       p_Var16 == (_Facet_base *)0x0)) &&
      ((DAT_14012b300[0x24] == (_Locimp)0x0 ||
...
LAB_140101d84:
      ...
      p_Var8 = DAT_14012b300 + 0x30;
      if (*(_Locimp **)(DAT_14012b300 + 0x28) != (_Locimp *)0x0) {
        p_Var8 = *(_Locimp **)(DAT_14012b300 + 0x28);
      }
      local_68 = (char *******)0x0;
      uStack_60 = 0;
      sStack_58 = 0;
      ...
      if ((longlong)_Size < 0) goto LAB_140102270;
      if (_Size < 0x10) {
        uStack_50 = 0xf;
        sStack_58 = _Size;
      ...
      *(char *)((longlong)pppppppcVar15 + _Size) = '\0';
      ...
      if (uStack_50 < 0x10) goto LAB_140101d84;
    }
  ...
  if ((((*(ulonglong *)(DAT_14012b300 + 0x18) <= uVar17) ||
      ...
      ((DAT_14012b300[0x24] == (_Locimp)0x0 ||
       ((p_Var8 = std::locale::_Getgloballocale(), *(ulonglong *)(p_Var8 + 0x18) <= uVar17 ||
        (p_Var16 = *(_Facet_base **)(*(longlong *)(p_Var8 + 0x10) + uVar17 * 8),
        p_Var16 == (_Facet_base *)0x0)))))) && (p_Var16 = p_Var6, p_Var6 == (_Facet_base *)0x0)) {
    _Var10 = std::ctype<char>::_Getcat((facet **)&local_f0,(locale *)&DAT_14012b2f8);
...
LAB_140102270:
  ...
  *(undefined1 (*) [16])(puVar11 + 4) = auVar19;
  local_a0 = 1;
  local_98 = &DAT_14012b2e8;
  local_90 = 0x400000100;
  local_88 = &DAT_14012b2e8;
  local_80 = 1;
  ...
  *piVar1 = *piVar1 + 1;
  ...
  if ((void *)auStack_d0._0_8_ != (void *)0x0) {
    ...
    if ((0xfff < (ulonglong)(lStack_c0 - auStack_d0._0_8_)) &&
       ...
       0x1f < (ulonglong)(auStack_d0._0_8_ + (-8 - (longlong)_Memory_00)))) goto LAB_140102265;
    free(_Memory_00);
  }
  atexit(FUN_140102650);
  atexit(FUN_1401026e0);
  _DAT_14012b520 = 0x43af000043a50000;
  _DAT_14012b528 = 299;
  return;
}
