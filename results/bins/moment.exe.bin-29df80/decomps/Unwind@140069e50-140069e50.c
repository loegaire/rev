...
void Unwind_140069e50(undefined8 param_1,longlong param_2)
...
LAB_140069f0d:
        ...
        if (uVar11 == uVar4) goto LAB_140069f0d;
      }
LAB_140069ec3:
...
LAB_14006a051:
  *(longlong *)(param_2 + 0x290) = param_2 + 0x940;
  *(undefined1 *)(param_2 + 0x1197) = 1;
  return;
LAB_14006a03f:
  (*pcVar10)(*(undefined8 *)(param_2 + 0x650),0,0x8000);
  goto LAB_14006a051;
}
