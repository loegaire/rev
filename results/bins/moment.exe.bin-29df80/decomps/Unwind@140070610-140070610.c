...
void Unwind_140070610(undefined8 param_1,longlong param_2)

{
  ...
  if (*(longlong *)(param_2 + 0x11f0) == 0) {
    return;
  }
  uVar4 = 0;
  lVar6 = readgsbase();
  puVar2 = (undefined8 *)**(undefined8 **)(*(longlong *)(*(longlong *)(lVar6 + 0x60) + 0x18) + 0x10)
  ;
  uVar5 = 0xe2398719;
  puVar9 = puVar2;
  do {
...
LAB_1400706bf:
      ...
      if ((ulonglong)uVar11 != 0) {
        ...
        if ((uVar4 <= uVar11) ||
           ((code *)(lVar6 + (ulonglong)*(uint *)(lVar3 + 0x8c + (longlong)*(int *)(lVar3 + 0x3c)))
            <= pcVar10)) {
          (*pcVar10)(*(undefined8 *)(param_2 + 0x11f0),0,0x8000);
          return;
        }
        uVar5 = 0x1cba1898;
        uVar4 = 0x1cba1898;
      ...
      if (uVar11 == uVar4) goto LAB_1400706bf;
    }
LAB_140070676:
