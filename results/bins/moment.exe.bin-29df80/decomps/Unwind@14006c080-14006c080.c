...
void Unwind_14006c080(undefined8 param_1,longlong param_2)
...
LAB_14006c13d:
        ...
        if (uVar11 == uVar4) goto LAB_14006c13d;
      }
LAB_14006c0f3:
...
LAB_14006c281:
  *(undefined8 *)(param_2 + 0x1e0) = 0xf;
  *(longlong *)(param_2 + 0x1d8) = param_2 + 0x780;
  *(undefined1 *)(param_2 + 0x1188) = 1;
  return;
LAB_14006c26f:
  (*pcVar10)(*(undefined8 *)(param_2 + 0x410),0,0x8000);
  goto LAB_14006c281;
}
