...
void Unwind_14006c510(undefined8 param_1,longlong param_2)
...
LAB_14006c5cd:
        ...
        if (uVar11 == uVar4) goto LAB_14006c5cd;
      }
LAB_14006c583:
...
LAB_14006c711:
  *(undefined8 *)(param_2 + 0x1c8) = 0xf;
  *(longlong *)(param_2 + 0x1c0) = param_2 + 0x740;
  *(undefined1 *)(param_2 + 0x1186) = 1;
  return;
LAB_14006c6ff:
  (*pcVar10)(*(undefined8 *)(param_2 + 0x3f0),0,0x8000);
  goto LAB_14006c711;
}
