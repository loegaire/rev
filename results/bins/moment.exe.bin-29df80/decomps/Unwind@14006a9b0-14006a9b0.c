...
void Unwind_14006a9b0(undefined8 param_1,longlong param_2)
...
LAB_14006aa6d:
        ...
        if (uVar11 == uVar4) goto LAB_14006aa6d;
      }
LAB_14006aa23:
...
LAB_14006abb1:
  *(undefined8 *)(param_2 + 600) = 0xf;
  *(longlong *)(param_2 + 0x250) = param_2 + 0x8c0;
  *(undefined1 *)(param_2 + 0x1192) = 1;
  return;
LAB_14006ab9f:
  (*pcVar10)(*(undefined8 *)(param_2 + 0x4b0),0,0x8000);
  goto LAB_14006abb1;
}
