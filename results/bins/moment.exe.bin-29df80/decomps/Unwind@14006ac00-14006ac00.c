...
void Unwind_14006ac00(undefined8 param_1,longlong param_2)
...
LAB_14006acbd:
        ...
        if (uVar11 == uVar4) goto LAB_14006acbd;
      }
LAB_14006ac73:
...
LAB_14006ae01:
  *(longlong *)(param_2 + 0x248) = param_2 + 0x880;
  *(undefined1 *)(param_2 + 0x1191) = 1;
  return;
LAB_14006adef:
  (*pcVar10)(*(undefined8 *)(param_2 + 0x5f0),0,0x8000);
  goto LAB_14006ae01;
}
