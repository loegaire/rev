...
longlong * FUN_1400bdcc0(longlong *param_1)

{
  ...
  pauVar3 = (undefined1 (*) [32])(*pcVar2)(0,0x33,0x3000,4);
  *param_1 = (longlong)pauVar3;
  *pauVar3 = ZEXT1232(ZEXT812(0));
  *(undefined1 (*) [32])(*pauVar3 + 0x13) = ZEXT1232(ZEXT812(0));
  if (*param_1 != 0) {
    ...
    *(byte *)*param_1 = bVar1 ^ 0x9a;
    plVar4 = (longlong *)(*(code *)0xe2058d4818eb9b75)();
    return plVar4;
  }
  return param_1;
}
