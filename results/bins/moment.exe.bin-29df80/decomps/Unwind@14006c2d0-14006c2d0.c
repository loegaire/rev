...
void Unwind_14006c2d0(undefined8 param_1,longlong param_2)
...
LAB_14006c38d:
        ...
        if (uVar11 == uVar4) goto LAB_14006c38d;
      }
LAB_14006c343:
...
LAB_14006c4d1:
  *(longlong *)(param_2 + 0x1d0) = param_2 + 0x740;
  *(undefined1 *)(param_2 + 0x1187) = 1;
  return;
LAB_14006c4bf:
  (*pcVar10)(*(undefined8 *)(param_2 + 0x550),0,0x8000);
  goto LAB_14006c4d1;
}
