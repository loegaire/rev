...
void Unwind_14006c9a0(undefined8 param_1,longlong param_2)
...
LAB_14006ca5d:
        ...
        if (uVar11 == uVar4) goto LAB_14006ca5d;
      }
LAB_14006ca13:
...
LAB_14006cba1:
  *(longlong *)(param_2 + 0x1b0) = param_2 + 0x700;
  *(undefined1 *)(param_2 + 0x1184) = 1;
  return;
LAB_14006cb8f:
  (*pcVar10)(*(undefined8 *)(param_2 + 0x6e0),0,0x8000);
  goto LAB_14006cba1;
}
