...
void Unwind_1400690a0(undefined8 param_1,longlong param_2)
...
LAB_14006915d:
        ...
        if (uVar11 == uVar4) goto LAB_14006915d;
      }
LAB_140069113:
...
LAB_1400692a1:
  *(longlong *)(param_2 + 0x2d8) = param_2 + 0xa00;
  *(undefined1 *)(param_2 + 0x119d) = 1;
  return;
LAB_14006928f:
  (*pcVar10)(*(undefined8 *)(param_2 + 0x3b0),0,0x8000);
  goto LAB_1400692a1;
}
