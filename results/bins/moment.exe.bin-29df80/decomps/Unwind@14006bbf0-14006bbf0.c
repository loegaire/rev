...
void Unwind_14006bbf0(undefined8 param_1,longlong param_2)
...
LAB_14006bcad:
        ...
        if (uVar11 == uVar4) goto LAB_14006bcad;
      }
LAB_14006bc63:
...
LAB_14006bdf1:
  *(undefined8 *)(param_2 + 0x1f8) = 0xf;
  *(longlong *)(param_2 + 0x1f0) = param_2 + 0x7c0;
  *(undefined1 *)(param_2 + 0x118a) = 1;
  return;
LAB_14006bddf:
  (*pcVar10)(*(undefined8 *)(param_2 + 0x430),0,0x8000);
  goto LAB_14006bdf1;
}
