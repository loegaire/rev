...
longlong * FUN_1400c0530(longlong *param_1)

{
  ...
  pauVar3 = (undefined1 (*) [16])(*pcVar2)(0,0x1a,0x3000,4);
  *param_1 = (longlong)pauVar3;
  auVar5._0_12_ = ZEXT812(0);
  auVar5._12_4_ = 0;
  *pauVar3 = auVar5;
  *(undefined1 (*) [16])(*pauVar3 + 10) = auVar5;
  if (*param_1 != 0) {
    ...
    *(byte *)*param_1 = bVar1 ^ 0x9a;
    plVar4 = (longlong *)(*(code *)0x75058d4818eb9e75)();
    return plVar4;
  }
  return param_1;
}
