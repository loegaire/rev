...
void Unwind_140068c10(undefined8 param_1,longlong param_2)
...
LAB_140068ccd:
        ...
        if (uVar11 == uVar4) goto LAB_140068ccd;
      }
LAB_140068c83:
...
LAB_140068e11:
  *(longlong *)(param_2 + 0x698) = param_2 + 0xa40;
  *(undefined1 *)(param_2 + 0x11c7) = 1;
  return;
LAB_140068dff:
  (*pcVar10)(*(undefined8 *)(param_2 + 0x3d0),0,0x8000);
  goto LAB_140068e11;
}
