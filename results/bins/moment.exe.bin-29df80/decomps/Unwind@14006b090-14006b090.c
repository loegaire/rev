...
void Unwind_14006b090(undefined8 param_1,longlong param_2)
...
LAB_14006b14d:
        ...
        if (uVar11 == uVar4) goto LAB_14006b14d;
      }
LAB_14006b103:
...
LAB_14006b291:
  *(longlong *)(param_2 + 0x230) = param_2 + 0x840;
  *(undefined1 *)(param_2 + 0x118f) = 1;
  return;
LAB_14006b27f:
  (*pcVar10)(*(undefined8 *)(param_2 + 0x5d0),0,0x8000);
  goto LAB_14006b291;
}
