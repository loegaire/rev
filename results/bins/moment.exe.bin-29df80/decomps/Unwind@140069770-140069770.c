...
void Unwind_140069770(undefined8 param_1,longlong param_2)
...
LAB_14006982d:
        ...
        if (uVar11 == uVar4) goto LAB_14006982d;
      }
LAB_1400697e3:
...
LAB_140069971:
  *(undefined8 *)(param_2 + 0x2b8) = 0xf;
  *(longlong *)(param_2 + 0x2b0) = param_2 + 0x9c0;
  *(undefined1 *)(param_2 + 0x119a) = 1;
  return;
LAB_14006995f:
  (*pcVar10)(*(undefined8 *)(param_2 + 0x530),0,0x8000);
  goto LAB_140069971;
}
