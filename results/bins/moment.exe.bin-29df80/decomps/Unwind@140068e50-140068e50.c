...
void Unwind_140068e50(undefined8 param_1,longlong param_2)
...
LAB_140068f0d:
        ...
        if (uVar11 == uVar4) goto LAB_140068f0d;
      }
LAB_140068ec3:
...
LAB_140069051:
  *(undefined8 *)(param_2 + 0x2e8) = 0xf;
  *(longlong *)(param_2 + 0x2e0) = param_2 + 0xa40;
  *(undefined1 *)(param_2 + 0x119e) = 1;
  return;
LAB_14006903f:
  (*pcVar10)(*(undefined8 *)(param_2 + 0x2f0),0,0x8000);
  goto LAB_140069051;
}
