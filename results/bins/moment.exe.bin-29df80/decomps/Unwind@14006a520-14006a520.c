...
void Unwind_14006a520(undefined8 param_1,longlong param_2)
...
LAB_14006a5dd:
        ...
        if (uVar11 == uVar4) goto LAB_14006a5dd;
      }
LAB_14006a593:
...
LAB_14006a721:
  *(undefined8 *)(param_2 + 0x270) = 0xf;
  *(longlong *)(param_2 + 0x268) = param_2 + 0x900;
  *(undefined1 *)(param_2 + 0x1194) = 1;
  return;
LAB_14006a70f:
  (*pcVar10)(*(undefined8 *)(param_2 + 0x4d0),0,0x8000);
  goto LAB_14006a721;
}
