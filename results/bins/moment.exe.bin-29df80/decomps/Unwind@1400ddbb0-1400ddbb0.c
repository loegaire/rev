...
void Unwind_1400ddbb0(undefined8 param_1,longlong param_2)

{
  ...
  pauVar2 = *(undefined1 (**) [16])(param_2 + 0x88);
  lVar8 = *(longlong *)(param_2 + 0x80);
  if (*(longlong *)(param_2 + 0x98) != *(longlong *)(param_2 + 0x90)) {
    puVar5 = (ulonglong *)(*(longlong *)(param_2 + 0x98) + 0x18);
    do {
      if (7 < *puVar5) {
        ...
        if ((0xfff < *puVar5 * 2 + 2) &&
           ...
           0x1f < (ulonglong)((longlong)pvVar3 + (-8 - (longlong)pvVar4)))) goto LAB_1400ddd47;
        free(pvVar4);
      }
      puVar5[-1] = 0;
      *puVar5 = 7;
