...
void Unwind_14006b9b0(undefined8 param_1,longlong param_2)
...
LAB_14006ba6d:
        ...
        if (uVar11 == uVar4) goto LAB_14006ba6d;
      }
LAB_14006ba23:
...
LAB_14006bbb1:
  *(longlong *)(param_2 + 0x200) = param_2 + 0x7c0;
  *(undefined1 *)(param_2 + 0x118b) = 1;
  return;
LAB_14006bb9f:
  (*pcVar10)(*(undefined8 *)(param_2 + 0x590),0,0x8000);
  goto LAB_14006bbb1;
}
