...
longlong * FUN_1400bce80(longlong *param_1)

{
  ...
  pauVar3 = (undefined1 (*) [16])(*pcVar2)(0,0x1e,0x3000,4);
  *param_1 = (longlong)pauVar3;
  auVar5._0_12_ = ZEXT812(0);
  auVar5._12_4_ = 0;
  *pauVar3 = auVar5;
  *(undefined1 (*) [16])(*pauVar3 + 0xe) = auVar5;
  if (*param_1 != 0) {
    ...
    *(ushort *)*param_1 = uVar1 ^ 0x1d9a;
    plVar4 = (longlong *)(*(code *)0x21058d481ceb9a75)();
    return plVar4;
  }
  return param_1;
}
