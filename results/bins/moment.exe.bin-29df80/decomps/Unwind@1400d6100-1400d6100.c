...
void Unwind_1400d6100(undefined8 param_1,longlong param_2)

{
  ...
  _Memory = *(longlong **)(param_2 + 0x2398);
    ...
    do {
      ...
      if (pvVar2 != (void *)0x0) {
        ...
        if ((0xfff < (ulonglong)(_Memory_00[9] - (longlong)pvVar2)) &&
           ...
           0x1f < (ulonglong)((longlong)pvVar2 + (-8 - (longlong)pvVar3)))) goto LAB_1400d6224;
        free(pvVar3);
