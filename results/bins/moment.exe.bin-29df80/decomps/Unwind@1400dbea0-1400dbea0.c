...
void Unwind_1400dbea0(undefined8 param_1,longlong param_2)

{
  ...
  plVar1 = *(longlong **)(param_2 + 0x208);
  pauVar2 = *(undefined1 (**) [16])(param_2 + 0x1f0);
  pvVar3 = *(void **)*pauVar2;
  if (pvVar3 != (void *)0x0) {
    pvVar5 = pvVar3;
    if ((0xfff < (ulonglong)
                 (*(longlong *)(*(longlong *)(param_2 + 0x210) + 0x48) - (longlong)pvVar3)) &&
    ...
    do {
      ...
      if (pvVar3 != (void *)0x0) {
        ...
        if ((0xfff < (ulonglong)(plVar6[9] - (longlong)pvVar3)) &&
           (pvVar5 = *(void **)((longlong)pvVar3 + -8),
           0x1f < (ulonglong)((longlong)pvVar3 + (-8 - (longlong)pvVar5)))) goto LAB_1400dc018;
        free(pvVar5);
