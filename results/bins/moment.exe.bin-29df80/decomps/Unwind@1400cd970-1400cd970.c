...
void Unwind_1400cd970(undefined8 param_1,longlong param_2)

{
  ...
  _Memory = *(longlong **)(param_2 + 0x498);
    ...
    do {
      ...
      if (pvVar2 != (void *)0x0) {
        ...
        if ((0xfff < (ulonglong)(_Memory_00[9] - (longlong)pvVar2)) &&
           ...
           0x1f < (ulonglong)((longlong)pvVar2 + (-8 - (longlong)pvVar3)))) goto LAB_1400cdb33;
        free(pvVar3);
        _Memory_00[7] = lVar4;
        _Memory_00[8] = lVar5;
        _Memory_00[9] = 0;
